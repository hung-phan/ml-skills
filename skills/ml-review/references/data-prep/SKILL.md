...
| [feature-engineering](feature-engineering/) | Classical-ML feature engineering — numeric transforms, categorical encoding, text/datetime features, interactions, featuretools, tsfresh |
...
| [dataset-curation](dataset-curation/) | Dataset engineering for foundation models — SFT / preference / CoT / tool-use formats, data quality vs quantity vs coverage, synthesis (Self-Instruct, Evol-Instruct, distillation), filtering, dedup, contamination, annotation ops, data versioning |
